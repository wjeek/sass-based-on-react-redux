...
class S_A_Product extends React.Component {
    constructor(props){
        super(props) ;
        this.state = {
            pageSize : 10 ,
    ...
    componentDidMount(){
        ...
        //params.tenantId = window.globalStore.getState().userstore.user.tenantId ;
        service.statistics.initMarketProduct(params,(error,data) => {
            this.props.initMarketProduct(data) ;
        }) ;
    }
    _evClick_filterSearch(){
        ...
        //params.tenantId = window.globalStore.getState().userstore.user.tenantId ;
        service.statistics.initMarketProduct(Object.assign({
            pageSize :10,
            pageNum : 1,
        },params),(error,data)=>{
            this.props.initMarketProduct(data) ;
            ...
            <div>
                <QueueAnim>
                    ...
                    <div className="tabel-wrap" key="anime-4">
                        <Table
                            dataSource={this.props.statistics.market.product.dataSource.data}
                            columns={this.props.COLUMNS}
                            pagination={{
                            showSizeChanger : true ,

                            total : this.props.statistics.market.product.totalCount ,
                            ...
                            onShowSizeChange : (current , pageSize)=>{
                                ...
                                self.setState({
                                    ...
                                    service.statistics.initMarketProduct(params,(error,data)=>{
                                        self.props.initMarketProduct(data) ;
                                    });
                                });
                            },
                            onChange : (value)=>{
